...
function _attachTopNavMenu () {
  var adjacentTopNavMenuDOM = "" +
    "<nav class='navbar navbar-expand-md navbar-dark fixed-top bg-dark'>" +
      "<a class='navbar-brand' href='#'>WebGIS Penginapan</a>" +
            "<button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarSupportedContent' aria-controls='navbarSupportedContent' aria-expanded='false' aria-label='Toggle navigation'>" +
              "<span class='navbar-toggler-icon'></span>" +
            "</button>"+
      "<div class='collapse navbar-collapse' id='navbarSupportedContent'>" +
        "<ul class='navbar-nav mr-auto'>" +
          "<li button class='btn btn-primary mb1 black bg-silver'>" +
            "<a href='./about.html'><i class='fa fa-question-circle white'></i>&nbsp;&nbsp;About</a>" +
          "</li>" +
          "<li button class='btn btn-primary mb1 black bg-silver'>" +
            "<a href='./tools.html'><i class='fa fa-wrench white'></i>&nbsp;&nbsp;Tools</a>" +
          "</li>" +
        "</ul>" +
      "</div>"  +
